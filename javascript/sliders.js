...
const slideshow02 = {
    ...
    slides: document.querySelector('.slides01'),
    slideItems: document.querySelectorAll('.item-container02'),
    currentIndex: 0,
    timer: null
  };
  ...
  const slideshow03 = {
    ...
    slideItems: document.querySelectorAll('.item-container03'),
    currentIndex: 0,
    timer: null
  };
  ...
  function handleNext(slideshow) {
    ...
    slideshow.slides.style.transform = `translateX(-${slideshow.currentIndex * slideshow.slideItems[0].offsetWidth}px)`;
  }
  ...
  //Define function to start the timer for a given slideshow
